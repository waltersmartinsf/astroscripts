...
def FoV_plot(img,sources,label_xcentroid ='xcentroid',label_ycentroid='ycentroid',figsize=(14,9),plot_sources=True,
            plot_max_sources=False,n_max_sources=2,save=False,s=14,show=False,plot_name='FoV_sources.png',
            plot_id=False,id_label='id',new_figure=True,colorbar=True):
    ...
    if plot_id == True:
        for i in range(len(sources)):
            plt.text(sources[label_xcentroid][i],sources[label_ycentroid][i],str(sources[id_label][i]),color='red')
    if save == True:
